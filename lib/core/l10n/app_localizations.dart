...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _translations = {
    ...
    'en': {
      ...
      'page_bookmark_added': 'Page bookmark added',
      'page_bookmark_removed': 'Page bookmark removed',
      'switch_to_ayah_view': 'Switch to Ayah view',
      'switch_to_page_view': 'Switch to Page view',
      'play_all': 'Play All',
    ...
    'ar': {
      ...
      'page_bookmark_added': 'تمت إضافة علامة للصفحة',
      'page_bookmark_removed': 'تمت إزالة علامة الصفحة',
      'switch_to_ayah_view': 'التبديل إلى عرض الآيات',
      'switch_to_page_view': 'التبديل إلى عرض الصفحة',
      'play_all': 'تشغيل الكل',
    ...
    'ur': {
      ...
      'bookmark_removed': 'بک مارک ہٹا دیا گیا',
      'page_bookmark_added': 'صفحہ بک مارک شامل ہوگیا',
      'page_bookmark_removed': 'صفحہ بک مارک ہٹا دیا گیا',
      'switch_to_ayah_view': 'آیت منظر پر جائیں',
      'switch_to_page_view': 'صفحہ منظر پر جائیں',
      'play_all': 'سب چلائیں',
      ...
      'juz': 'پارہ',
      'translation': 'ترجمہ',
      'playback_ayah': 'پلے بیک آیت',
      'now_playing': 'اب چل رہا ہے',
      'highlighted': 'نمایاں کیا گیا',
    ...
    'tr': {
      ...
      'page_bookmark_added': 'Sayfa yer imi eklendi',
      'page_bookmark_removed': 'Sayfa yer imi kaldırıldı',
      'switch_to_ayah_view': 'Ayet görünümüne geç',
      'switch_to_page_view': 'Sayfa görünümüne geç',
      'play_all': 'Tümünü oynat',
      'tajweed_colors': 'Tecvit renkleri',
      'tab_home': 'Ana Sayfa',
      'tab_reader': 'Okuma',
      'tab_quiz': 'Quiz',
      'tab_rules': 'Kurallar',
    ...
    'fr': {
      ...
      'page_bookmark_added': 'Signet de page ajouté',
      'page_bookmark_removed': 'Signet de page supprimé',
      'switch_to_ayah_view': 'Passer en vue verset',
      'switch_to_page_view': 'Passer en vue page',
      'play_all': 'Tout lire',
    ...
    'id': {
      ...
      'page_bookmark_added': 'Bookmark halaman ditambahkan',
      'page_bookmark_removed': 'Bookmark halaman dihapus',
      'switch_to_ayah_view': 'Beralih ke tampilan ayat',
      'switch_to_page_view': 'Beralih ke tampilan halaman',
    ...
    'de': {
      ...
      'page_bookmark_added': 'Seiten-Lesezeichen hinzugefügt',
      'page_bookmark_removed': 'Seiten-Lesezeichen entfernt',
      'switch_to_ayah_view': 'Zur Versansicht wechseln',
      'switch_to_page_view': 'Zur Seitenansicht wechseln',
      ...
      'playback_ayah': 'Wiedergabevers',
      'now_playing': 'Wird jetzt abgespielt',
    ...
    'es': {
      ...
      'page_bookmark_added': 'Marcador de página añadido',
      'page_bookmark_removed': 'Marcador de página eliminado',
      'switch_to_ayah_view': 'Cambiar a vista de aleya',
      'switch_to_page_view': 'Cambiar a vista de página',
      ...
      'playback_ayah': 'Aleya de reproducción',
