...
class QuizRepository {
  ...
  static const Map<TajweedRule, List<String>> _highlightFragments = {
    ...
    TajweedRule.sajdah: ['۩'],
    TajweedRule.maddLazimKalimiMuthaqqal: ['آلّ'],
    TajweedRule.maddLazimKalimiMukhaffaf: ['آلْ'],
    TajweedRule.maddLazimHarfiMuthaqqal: ['لٓ'],
    TajweedRule.maddLazimHarfiMukhaffaf: ['سٓ'],
    TajweedRule.maddAridLissukun: ['هُونَ', 'عِينُ'],
    TajweedRule.maddLin: ['رَيْشٍ', 'خَوْفٍ'],
